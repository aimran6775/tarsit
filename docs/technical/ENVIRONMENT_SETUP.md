...
# ============================================
# File uploads handled via Supabase Storage buckets
# Buckets to create: business-images, profile-avatars
# SUPABASE_URL and SUPABASE_ANON_KEY already configured above
