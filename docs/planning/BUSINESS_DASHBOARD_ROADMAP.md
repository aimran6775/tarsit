...
- [x] **Appointments Toggle** - Enable/disable online booking
- [x] **Messaging Toggle** - Enable/disable customer chat
- [x] **Reviews Toggle** - Show/hide reviews section
- [x] **Services Toggle** - Show/hide services list
- [x] **Hours Toggle** - Show/hide business hours
- [x] **Phone Toggle** - Show/hide phone number
- [x] **Website Toggle** - Show/hide website link
