      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative z-10">
        <div className="w-full max-w-md">
          ...
          <button
            ...
            className="w-full py-3 px-4 bg-white/5 backdrop-blur-xl border border-white/10 text-white font-medium rounded-xl hover:bg-white/10 active:bg-white/15 disabled:opacity-50 flex items-center justify-center gap-3 transition-all active:scale-[0.99]"
          >
            {isGoogleLoading ? (
              <>
                <div className="w-5 h-5 border-2 border-white/30 border-t-white rounded-full animate-spin" />
