      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-lg text-neutral-400 max-w-2xl mx-auto">
            Have a question, feedback, or need help? We'd love to hear from you. Our team is here to
            help.
          </p>
        </div>
      </section>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="business" className="bg-neutral-900">
                        Presence Help
                      </option>
                      <option value="feedback" className="bg-neutral-900">
                        Feedback / Suggestions
                      </option>
                      <option value="partnership" className="bg-neutral-900">
                        Partnership Opportunities
                      </option>
                      <option value="press" className="bg-neutral-900">
                        Press / Media
                      </option>
                    </select>
                  </div>
            ...
            <div>
              ...
              <div className="p-6 rounded-2xl bg-gradient-to-br from-purple-500/10 to-indigo-500/10 border border-purple-500/20">
                ...
                <p className="text-neutral-400 text-sm mb-4">
                  Check out our help center for answers to common questions about using Tarsit as a
