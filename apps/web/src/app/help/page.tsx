...
const faqs = [
  ...
  },
  {
    ...
    description: 'Create and manage your presence',
    questions: [
      {
        q: 'How can I create my presence on Tarsit?',
        a: 'Click "Create your Presence" in the menu to get started. Fill in your details, add photos and services, and your presence will be live after verification.',
      },
      {
        q: 'Is there a fee for businesses?',
        a: 'Basic presences are free! We also offer premium features for businesses that want additional visibility and tools.',
      },
    ],
  },
];
            ...
            <div className="relative flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-white/60 mb-4 max-w-xl">
                  TARS is our AI assistant inspired by the movie Interstellar. With 75% humor and
                  95% honesty, TARS can help you with anything - from finding businesses to managing
                  your bookings.
                </p>
                  ...
                  <div className="border-t border-white/10">
                    ...
                    <div className="p-4 bg-purple-500/5">
                      <button
                        onClick={() =>
                          handleQuickQuestion(
                            `Tell me more about ${category.category.toLowerCase()}`
                          )
                        }
