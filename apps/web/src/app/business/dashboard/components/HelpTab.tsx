...
export function HelpTab({ businessId, businessName, ownerEmail }: HelpTabProps) {
    const [activeSection, setActiveSection] = useState<'tars' | 'faq' | 'contact' | 'resources'>('tars');
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-white/60">
                            Get instant answers from TARS or browse our resources
                        </p>
                    </div>
            ...
            <div className="flex gap-2 p-1 bg-white/5 rounded-xl">
                {[
                    ...
                    <button
                        ...
                        className={`flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-lg font-medium transition-all ${activeSection === tab.id
