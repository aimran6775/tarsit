...
export function PhotosTab({
  ...
  const [uploadProgress, setUploadProgress] = useState<{ total: number; completed: number } | null>(
    null
  );
    ...
    <div className="space-y-8">
      ...
      <div className="bg-white/5 rounded-xl p-6 border border-white/10">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          {/* Logo */}
          <div>
            <label className="block text-sm font-medium text-white/70 mb-2">Business Logo</label>
      ...
      <div className="bg-white/5 rounded-xl p-6 border border-white/10">
        ...
        >
          <div className="p-8 text-center">
            ...
            <p className="text-sm text-white/40 mb-4">or click the "Add Photos" button above</p>
        ...
        <div className="flex items-start gap-3 p-4 bg-purple-500/10 border border-purple-500/20 rounded-xl mb-6">
          ...
          <div className="text-sm">
            <p className="text-white/80">Photos help customers understand your business better.</p>
            <p className="text-white/50 mt-1">
              Click the star icon to set a photo as featured. Featured photos appear first in search
              results.
            </p>
          </div>
        </div>
        ...
        {photos.length > 0 ? (
          ...
          <div className="text-center py-12 border-2 border-dashed border-white/20 rounded-xl">
            ...
            <p className="text-sm text-white/40">Upload photos to showcase your business</p>
          </div>
        )}
      </div>
    </div>
