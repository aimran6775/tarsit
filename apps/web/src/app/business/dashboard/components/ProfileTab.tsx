...
export function ProfileTab({ business, onBusinessUpdated }: ProfileTabProps) {
  ...
  const handleSave = async () => {
    ...
    if (!normalizedSlug) {
      toast.error('Business URL cannot be empty');
      return;
    }
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-white/40 mt-1">
              Public link: /business/{formData.slug || 'your-business'} (changing this will change
              your public URL)
            </p>
          </div>
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    priceRange: e.target.value as 'BUDGET' | 'MODERATE' | 'EXPENSIVE',
                  })
                }
                className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-purple-500/50 appearance-none"
              >
                <option value="BUDGET" className="bg-neutral-900">
                  $ - Budget Friendly
                </option>
                <option value="MODERATE" className="bg-neutral-900">
                  $$ - Moderate
                </option>
                <option value="EXPENSIVE" className="bg-neutral-900">
                  $$$ - Premium
                </option>
              </select>
            </div>
