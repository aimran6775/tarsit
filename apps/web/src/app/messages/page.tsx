...
export default function MessagesPage() {
  ...
  return (
    <div className="min-h-screen bg-neutral-950 pt-16">
      {/* Page Header - Desktop */}
      <div className="hidden lg:block bg-white/5 backdrop-blur-xl border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
          <h1 className="text-xl font-bold text-white">Messages</h1>
          <p className="text-sm text-white/50">Chat with businesses</p>
        </div>
      </div>
      ...
      <div className="flex h-[calc(100vh-64px-73px)] lg:h-[calc(100vh-64px-85px)] overflow-hidden">
        {/* Chat List Sidebar */}
        <ChatListSidebar
          chats={chats}
          selectedChat={selectedChat}
