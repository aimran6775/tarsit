...
import { ArrowRight, Building2, ChevronRight, Grid, Search, Star, TrendingUp } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-neutral-950 flex items-center justify-center px-4">
        <div className="text-center max-w-md">
          ...
          <p className="text-neutral-400 mb-6">There are no categories to display at the moment.</p>
          <Link
            href="/"
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-neutral-400 max-w-2xl mx-auto mb-8">
              Discover local businesses across {categories.length}+ categories. From beauty to tech,
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-neutral-400">
                        <span className="text-white font-medium">
                          {(category._count?.businesses || 0).toLocaleString()}
                        </span>{' '}
                        businesses
                      </span>
        ...
        <section className="mt-16">
          <div className="p-8 md:p-12 rounded-2xl bg-gradient-to-br from-purple-500/10 to-indigo-500/10 border border-purple-500/20 text-center">
            ...
            <p className="text-neutral-400 mb-8 max-w-xl mx-auto">
              Try our search to find what you need by name, service, or location
            </p>
