...
import { EmptyFavoritesIllustration } from '@/components/illustrations';
    ...
    <div>
      ...
      {favorites.length === 0 ? (
        <div className="bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 p-10 text-center">
          <EmptyFavoritesIllustration className="w-48 h-36 mx-auto mb-6" />
              ...
              <Link href={`/business/${fav.business.slug}`}>
                <div className="relative h-32 bg-neutral-900">
                  {fav.business.coverImage ? (
                    <Image src={fav.business.coverImage} alt="" fill sizes="(max-width: 640px) 100vw, 50vw" className="object-cover" />
                  ) : (
