...
export class CreateBusinessDto {
  ...
  @ApiProperty({ example: 'book', enum: ['book', 'message'], required: false })
  @IsOptional()
  @IsString()
  @IsIn(['book', 'message'])
  publicPagePrimaryCta?: 'book' | 'message';

  @ApiProperty({
    example: ['about', 'photos', 'services', 'reviews', 'location'],
    isArray: true,
    required: false,
  })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
  @IsIn(['about', 'photos', 'services', 'reviews', 'location'], { each: true })
  publicPageSectionOrder?: string[];
}
